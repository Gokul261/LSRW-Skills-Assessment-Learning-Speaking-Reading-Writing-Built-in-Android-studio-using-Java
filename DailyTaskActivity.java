...
public class DailyTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseRef = FirebaseDatabase.getInstance().getReference("DailyTaskScores");
        ...
        questionList = loadDailyTaskQuestions();
    ...
    private void navigateToResultPage() {
        Intent intent = new Intent(DailyTaskActivity.this, ResultDailyActivity.class);
    ...
    private List<QuestionModel> loadDailyTaskQuestions() {
        List<QuestionModel> questions = new ArrayList<>();
        Set<String> uniqueQuestions = new HashSet<>();

        try {
            AssetManager assetManager = getAssets();
            InputStream is = assetManager.open("DailyTask.csv");
